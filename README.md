...
NOTE: This version is for Magento 2.2 or higher. Please use [version 1.3.1](https://github.com/SpotlerSoftware/magento2-mailplus-connector/releases/tag/v1.3.1) for Magento 2.1. A MailPlus eCom account is required to utilize the following features. 

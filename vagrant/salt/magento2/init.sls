...
magento2-community-edition:
  cmd.run:
    ...
    - name: |
        ...
        sudo composer -v create-project --prefer-dist -s dev --repository-url=https://nexus.mailplus.nl/satis/magento/ magento/project-community-edition /var/www/html/ 2.0.*
    - require:
      - cmd: get-composer
      - pkg: git
